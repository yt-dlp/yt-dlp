...
The available fields are:
 ...
 - `download_count` (numeric): Number of times the video has been downloaded (by the platform's own downloader, not by YouTube Downloader Plus and/or any other YouTube Downloader deritives including itself)
