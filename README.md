...
* Passing `--simulate` (or calling `extract_info` with `download=False`) no longer alter the default format selection. See [#9843](https://github.com/yt-dlp/yt-dlp/issues/9843) for details.
