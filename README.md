...
[![Donate](https://img.shields.io/badge/_-Donate-red.svg?logo=githubsponsors&labelColor=555555&style=for-the-badge)](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/Collaborators.md#collaborators "Donate")
...
[![Supported Sites](https://img.shields.io/badge/-Supported_Sites-brightgreen.svg?style=for-the-badge)](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/supportedsites.md "Supported Sites")
[![License: Unlicense](https://img.shields.io/badge/-Unlicense-blue.svg?style=for-the-badge)](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/LICENSE "License")
...
yt-dlp is a feature-rich command-line audio/video downloader with support for [thousands of sites](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/supportedsites.md). The project is a fork of [youtube-dl](https://github.com/ytdl-org/youtube-dl) based on the now inactive [youtube-dlc](https://github.com/blackjack4494/yt-dlc).
...
* [CONTRIBUTING](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/CONTRIBUTING.md#contributing-to-yt-dlp)
    * [Opening an Issue](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/CONTRIBUTING.md#opening-an-issue)
    * [Developer Instructions](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/CONTRIBUTING.md#developer-instructions)
...
### Forking the project
If you fork the project on GitHub, you can run your fork's [build workflow](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/.github/workflows/build.yml) to automatically build the selected version(s) as artifacts. Alternatively, you can run the [release workflow](https://github.com/yt-dlp/yt-dlp/tree/VARIABL/.github/workflows/release.yml) or enable the [nightly workflow](https://github.com/yt-dlp/yt-dlp/tree/VARIABL/.github/workflows/release-nightly.yml) to create full (pre-)releases.
...
* **New and fixed extractors**: Many new extractors have been added and a lot of existing ones have been fixed. See the [changelog](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/Changelog.md) or the [list of supported sites](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/supportedsites.md)
...
See [changelog](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/Changelog.md) or [commits](https://github.com/yt-dlp/yt-dlp/commits) for the full list of changes
...
# CONTRIBUTING
See [CONTRIBUTING.md](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/CONTRIBUTING.md#contributing-to-yt-dlp) for instructions on [Opening an Issue](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/CONTRIBUTING.md#opening-an-issue) and [Contributing code to the project](https://github.com/yt-dlp/yt-dlp/tree/VARIABLE/CONTRIBUTING.md#developer-instructions)
