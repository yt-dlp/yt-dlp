...
* [**pycryptodome**](https://github.com/Legrandin/pycryptodome) - For decrypting HLS streams faster. Licenced under [BSD2](https://github.com/Legrandin/pycryptodome/blob/master/LICENSE.rst)
