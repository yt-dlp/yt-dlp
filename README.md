...
* `impersonate`: Target(s) to try and impersonate with the initial webpage request; e.g. `safari,chrome-110`. Use `generic:impersonate` to use any available target, and use `false` to disable impersonation (default)
