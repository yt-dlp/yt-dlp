...
* `impersonate`: Targets to try and impersonate in the website request; e.g. `safari,chrome-110`. By default any available target will be used. Set to `false` to not use impersonation.
