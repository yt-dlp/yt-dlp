...
* The upload date in UTC timezone is preferred over the non-UTC upload date for YouTube videos in [most circumstances](https://github.com/yt-dlp/yt-dlp/blob/master/yt_dlp/extractor/youtube.py#L3898-L3900). Use `--compat-options no-youtube-prefer-utc-upload-date` to prefer the non-UTC upload date.
