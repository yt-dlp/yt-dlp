...
* All *experiences* of a funimation episode are considered as a single video. This behavior breaks existing archives. Use `--compat-options funimation-single-player` to extract information from only the default player
