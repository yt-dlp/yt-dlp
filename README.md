...
* `player_js_version`: The player javascript hash and sts to use for signature and nsig deciphering. Needs to be formatted as `sts@hash`. Currently forcing `20348@0004de42`. You can use `actual` to go with what is prescribed by the site
