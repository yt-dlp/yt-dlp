...
class TestJSInterpreter(unittest.TestCase):
    ...
    def test_string_concat_extended(self):
        # str+array
        self._test('function f(){return "a" + [];}', 'a')
        self._test('function f(){return "a" + [true];}', 'atrue')
        self._test('function f(){return "a" + [false];}', 'afalse')
        self._test('function f(){return "a" + [null];}', 'a')
        self._test('function f(){return "a" + [undefined];}', 'a')
        self._test('function f(){return "a" + [Infinity];}', 'aInfinity')
        self._test('function f(){return "a" + [NaN];}', 'aNaN')
        self._test('function f(){return "a" + ["b"];}', 'ab')
        self._test('function f(){return "a" + [1];}', 'a1')
        self._test('function f(){return "a" + [{}];}', 'a[object Object]')
        self._test('function f(){return "a" + [1,"2",[[true]],null];}', 'a1,2,true,')
        self._test('function f(){return "a" + []["a"];}', 'aundefined')
        self._test('function f(){return "a" + [][1];}', 'aundefined')
        self._test('function f(){return "a" + [][[]];}', 'aundefined')
        self._test('function f(){return "a" + [][{}];}', 'aundefined')
        self._test('function f(){return "a" + [][true];}', 'aundefined')
        self._test('function f(){return "a" + [][false];}', 'aundefined')
        self._test('function f(){return "a" + [][null];}', 'aundefined')
        self._test('function f(){return "a" + [][undefined];}', 'aundefined')
        self._test('function f(){let x = "a"; x += []; return x;}', 'a')
        self._test('function f(){let x = "a"; x += [true]; return x;}', 'atrue')
        self._test('function f(){let x = "a"; x += [false]; return x;}', 'afalse')
        self._test('function f(){let x = "a"; x += [null]; return x;}', 'a')
        self._test('function f(){let x = "a"; x += [undefined]; return x;}', 'a')
        self._test('function f(){let x = "a"; x += [Infinity]; return x;}', 'aInfinity')
        self._test('function f(){let x = "a"; x += [NaN]; return x;}', 'aNaN')
        self._test('function f(){let x = "a"; x += ["b"]; return x;}', 'ab')
        self._test('function f(){let x = "a"; x += [1]; return x;}', 'a1')
        self._test('function f(){let x = "a"; x += [{}]; return x;}', 'a[object Object]')
        self._test('function f(){let x = "a"; x += [1,"2",[[true]],null]; return x;}', 'a1,2,true,')
        self._test('function f(){let x = "a"; x += []["a"]; return x;}', 'aundefined')
        self._test('function f(){let x = "a"; x += [][1]; return x;}', 'aundefined')
        self._test('function f(){let x = "a"; x += [][[]]; return x;}', 'aundefined')
        self._test('function f(){let x = "a"; x += [][{}]; return x;}', 'aundefined')
        self._test('function f(){let x = "a"; x += [][true]; return x;}', 'aundefined')
        self._test('function f(){let x = "a"; x += [][false]; return x;}', 'aundefined')
        self._test('function f(){let x = "a"; x += [][null]; return x;}', 'aundefined')
        self._test('function f(){let x = "a"; x += [][undefined]; return x;}', 'aundefined')
        # str+object
        self._test('function f(){return "a" + {};}', 'a[object Object]')
        self._test('function f(){return "a" + {foo:"bar"};}', 'a[object Object]')
        self._test('function f(){let x = "a"; x += {}; return x;}', 'a[object Object]')
        self._test('function f(){let x = "a"; x += {foo:"bar"}; return x;}', 'a[object Object]')
        # str+boolean, etc.
        self._test('function f(){return "a" + true;}', 'atrue')
        self._test('function f(){return "a" + false;}', 'afalse')
        self._test('function f(){return "a" + null;}', 'anull')
        self._test('function f(){return "a" + undefined;}', 'aundefined')
        self._test('function f(){return "a" + Infinity;}', 'aInfinity')
        self._test('function f(){return "a" + NaN;}', 'aNaN')
        self._test('function f(){let x = "a"; x += true; return x;}', 'atrue')
        self._test('function f(){let x = "a"; x += false; return x;}', 'afalse')
        self._test('function f(){let x = "a"; x += null; return x;}', 'anull')
        self._test('function f(){let x = "a"; x += undefined; return x;}', 'aundefined')
        self._test('function f(){let x = "a"; x += Infinity; return x;}', 'aInfinity')
        self._test('function f(){let x = "a"; x += NaN; return x;}', 'aNaN')
