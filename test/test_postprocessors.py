...
class TestModifyChaptersPP(unittest.TestCase):
    ...
    @staticmethod
    def _sponsor_segment(start, end, cat, remove=False):
        c = {'start_time': start, 'end_time': end, '_titles': [(SponsorBlockPP.CATEGORIES[cat], start, end)]}
        if remove:
            c['remove'] = True
        return c

    @staticmethod
    def _sponsor_chapter(start, end, title, remove=False):
        c = {'start_time': start, 'end_time': end, '_titles': [(title, start, end)]}
        if remove:
            c['remove'] = True
        return c
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithSponsors(self):
        chapters = self._chapters([70], ['c']) + [
            self._sponsor_segment(10, 20, 'sponsor'),
    ...
    def test_remove_marked_arrange_sponsors_UniqueNamesForOverlappingSponsors(self):
        chapters = self._chapters([120], ['c']) + [
            self._sponsor_segment(10, 45, 'sponsor'), self._sponsor_segment(20, 40, 'selfpromo'),
            self._sponsor_segment(50, 70, 'sponsor'), self._sponsor_segment(60, 85, 'selfpromo'),
            self._sponsor_segment(90, 120, 'selfpromo'), self._sponsor_segment(100, 110, 'sponsor')]
        expected = self._chapters(
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithCuts(self):
        cuts = [self._chapter(10, 20, remove=True),
                self._sponsor_segment(30, 40, 'sponsor', remove=True),
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithSponsorsAndCuts(self):
        chapters = self._chapters([70], ['c']) + [
            self._sponsor_segment(10, 20, 'sponsor'),
            self._sponsor_segment(30, 40, 'selfpromo', remove=True),
            self._sponsor_segment(50, 60, 'interaction')]
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithSponsorCutInTheMiddle(self):
        cuts = [self._sponsor_segment(20, 30, 'selfpromo', remove=True),
                self._chapter(40, 50, remove=True)]
        chapters = self._chapters([70], ['c']) + [self._sponsor_segment(10, 60, 'sponsor')] + cuts
        expected = self._chapters(
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithCutHidingSponsor(self):
        cuts = [self._sponsor_segment(20, 50, 'selfpromo', remove=True)]
        chapters = self._chapters([60], ['c']) + [
            self._sponsor_segment(10, 20, 'intro'),
            self._sponsor_segment(30, 40, 'sponsor'),
            self._sponsor_segment(50, 60, 'outro'),
        ] + cuts
        expected = self._chapters(
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithAdjacentSponsors(self):
        chapters = self._chapters([70], ['c']) + [
            self._sponsor_segment(10, 20, 'sponsor'),
            self._sponsor_segment(20, 30, 'selfpromo'),
            self._sponsor_segment(30, 40, 'interaction')]
        expected = self._chapters(
            [10, 20, 30, 40, 70],
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithAdjacentCuts(self):
        chapters = self._chapters([70], ['c']) + [
            self._sponsor_segment(10, 20, 'sponsor'),
            self._sponsor_segment(20, 30, 'interaction', remove=True),
            self._chapter(30, 40, remove=True),
            self._sponsor_segment(40, 50, 'selfpromo', remove=True),
            self._sponsor_segment(50, 60, 'interaction')]
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithOverlappingSponsors(self):
        chapters = self._chapters([70], ['c']) + [
            self._sponsor_segment(10, 30, 'sponsor'),
            self._sponsor_segment(20, 50, 'selfpromo'),
            self._sponsor_segment(40, 60, 'interaction')]
        expected = self._chapters(
            [10, 20, 30, 40, 50, 60, 70],
            ['c', '[SponsorBlock]: Sponsor', '[SponsorBlock]: Sponsor, Unpaid/Self Promotion',
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithOverlappingCuts(self):
        chapters = self._chapters([70], ['c']) + [
            self._sponsor_segment(10, 30, 'sponsor', remove=True),
            self._sponsor_segment(20, 50, 'selfpromo', remove=True),
            self._sponsor_segment(40, 60, 'interaction', remove=True)]
        self._remove_marked_arrange_sponsors_test_impl(
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithRunsOfOverlappingSponsors(self):
        chapters = self._chapters([170], ['c']) + [
            self._sponsor_segment(0, 30, 'intro'),
            self._sponsor_segment(20, 50, 'sponsor'),
            self._sponsor_segment(40, 60, 'selfpromo'),
            self._sponsor_segment(70, 90, 'sponsor'),
            self._sponsor_segment(80, 100, 'sponsor'),
            self._sponsor_segment(90, 110, 'sponsor'),
            self._sponsor_segment(120, 140, 'selfpromo'),
            self._sponsor_segment(130, 160, 'interaction'),
            self._sponsor_segment(150, 170, 'outro')]
        expected = self._chapters(
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithRunsOfOverlappingCuts(self):
        chapters = self._chapters([170], ['c']) + [
            ...
            self._sponsor_segment(20, 50, 'sponsor', remove=True),
            self._chapter(40, 60, remove=True),
            self._sponsor_segment(70, 90, 'sponsor', remove=True),
            self._chapter(80, 100, remove=True),
            self._chapter(90, 110, remove=True),
            self._sponsor_segment(120, 140, 'sponsor', remove=True),
            self._sponsor_segment(130, 160, 'selfpromo', remove=True),
    ...
    def test_remove_marked_arrange_sponsors_OverlappingSponsorsDifferentTitlesAfterCut(self):
        chapters = self._chapters([60], ['c']) + [
            self._sponsor_segment(10, 60, 'sponsor'),
            self._sponsor_segment(10, 40, 'intro'),
            self._sponsor_segment(30, 50, 'interaction'),
            self._sponsor_segment(30, 50, 'selfpromo', remove=True),
            self._sponsor_segment(40, 50, 'interaction'),
            self._sponsor_segment(50, 60, 'outro')]
        expected = self._chapters(
    ...
    def test_remove_marked_arrange_sponsors_SponsorsNoLongerOverlapAfterCut(self):
        chapters = self._chapters([70], ['c']) + [
            self._sponsor_segment(10, 30, 'sponsor'),
            self._sponsor_segment(20, 50, 'interaction'),
            self._sponsor_segment(30, 50, 'selfpromo', remove=True),
            self._sponsor_segment(40, 60, 'sponsor'),
            self._sponsor_segment(50, 60, 'interaction')]
        expected = self._chapters(
    ...
    def test_remove_marked_arrange_sponsors_SponsorsStillOverlapAfterCut(self):
        chapters = self._chapters([70], ['c']) + [
            self._sponsor_segment(10, 60, 'sponsor'),
            self._sponsor_segment(20, 60, 'interaction'),
            self._sponsor_segment(30, 50, 'selfpromo', remove=True)]
        expected = self._chapters(
            [10, 20, 40, 50], ['c', '[SponsorBlock]: Sponsor',
                               '[SponsorBlock]: Sponsor, Interaction Reminder', 'c'])
    ...
    def test_remove_marked_arrange_sponsors_ChapterWithRunsOfOverlappingSponsorsAndCuts(self):
        chapters = self._chapters([200], ['c']) + [
            self._sponsor_segment(10, 40, 'sponsor'),
            self._sponsor_segment(10, 30, 'intro'),
            self._chapter(20, 30, remove=True),
            self._sponsor_segment(30, 40, 'selfpromo'),
            self._sponsor_segment(50, 70, 'sponsor'),
            self._sponsor_segment(60, 80, 'interaction'),
            self._chapter(70, 80, remove=True),
            self._sponsor_segment(70, 90, 'sponsor'),
            self._sponsor_segment(80, 100, 'interaction'),
            self._sponsor_segment(120, 170, 'selfpromo'),
            self._sponsor_segment(130, 180, 'outro'),
    ...
    def test_remove_marked_arrange_sponsors_SponsorOverlapsMultipleChapters(self):
        chapters = (self._chapters([20, 40, 60, 80, 100], ['c1', 'c2', 'c3', 'c4', 'c5'])
                    + [self._sponsor_segment(10, 90, 'sponsor')])
    ...
    def test_remove_marked_arrange_sponsors_SponsorsWithinSomeChaptersAndOverlappingOthers(self):
        chapters = (self._chapters([10, 40, 60, 80], ['c1', 'c2', 'c3', 'c4'])
                    + [self._sponsor_segment(20, 30, 'sponsor'),
                       self._sponsor_segment(50, 70, 'selfpromo')])
    ...
    def test_remove_marked_arrange_sponsors_ChaptersAfterLastSponsor(self):
        chapters = (self._chapters([20, 40, 50, 60], ['c1', 'c2', 'c3', 'c4'])
                    + [self._sponsor_segment(10, 30, 'music_offtopic')])
        expected = self._chapters(
            [10, 30, 40, 50, 60],
    ...
    def test_remove_marked_arrange_sponsors_SponsorsAtVideoBoundaries(self):
        chapters = (self._chapters([20, 40, 60], ['c1', 'c2', 'c3'])
                    + [self._sponsor_segment(0, 10, 'intro'), self._sponsor_segment(50, 60, 'outro')])
        expected = self._chapters(
    ...
    def test_remove_marked_arrange_sponsors_SponsorsOverlapChaptersAtVideoBoundaries(self):
        chapters = (self._chapters([10, 40, 50], ['c1', 'c2', 'c3'])
                    + [self._sponsor_segment(0, 20, 'intro'), self._sponsor_segment(30, 50, 'outro')])
        expected = self._chapters(
    ...
    def test_remove_marked_arrange_sponsors_EverythingSponsored(self):
        chapters = (self._chapters([10, 20, 30, 40], ['c1', 'c2', 'c3', 'c4'])
                    + [self._sponsor_segment(0, 20, 'intro'), self._sponsor_segment(20, 40, 'outro')])
    ...
    def test_remove_marked_arrange_sponsors_TinySponsorsAreIgnored(self):
        chapters = [self._sponsor_segment(0, 0.1, 'intro'), self._chapter(0.1, 0.2, 'c1'),
                    self._sponsor_segment(0.2, 0.3, 'sponsor'), self._chapter(0.3, 0.4, 'c2'),
                    self._sponsor_segment(0.4, 0.5, 'outro')]
        self._remove_marked_arrange_sponsors_test_impl(
    ...
    def test_remove_marked_arrange_sponsors_TinyChaptersResultingFromSponsorOverlapAreIgnored(self):
        chapters = self._chapters([1, 3, 4], ['c1', 'c2', 'c3']) + [
            self._sponsor_segment(1.5, 2.5, 'sponsor')]
        self._remove_marked_arrange_sponsors_test_impl(
    ...
    def test_remove_marked_arrange_sponsors_TinySponsorsOverlapsAreIgnored(self):
        chapters = self._chapters([2, 3, 5], ['c1', 'c2', 'c3']) + [
            self._sponsor_segment(1, 3, 'sponsor'),
            self._sponsor_segment(2.5, 4, 'selfpromo')
        ]
        self._remove_marked_arrange_sponsors_test_impl(
    ...
    def test_remove_marked_arrange_sponsors_TinySponsorsPrependedToTheNextSponsor(self):
        chapters = self._chapters([4], ['c']) + [
            self._sponsor_segment(1.5, 2, 'sponsor'),
            self._sponsor_segment(2, 4, 'selfpromo')
        ]
        self._remove_marked_arrange_sponsors_test_impl(
    ...
    def test_remove_marked_arrange_sponsors_SmallestSponsorInTheOverlapGetsNamed(self):
        ...
        chapters = self._chapters([10], ['c']) + [
            self._sponsor_segment(2, 8, 'sponsor'),
            self._sponsor_segment(4, 6, 'selfpromo')
        ]
        self._remove_marked_arrange_sponsors_test_impl(
