...
lock 2024.10.22 win(?:_x86)?_exe Python 3\.[78]\D.+ Windows-(?:7-|2008ServerR2)
'''
...
lockV2 yt-dlp/yt-dlp 2024.10.22 win(?:_x86)?_exe Python 3\.[78]\D.+.+ Windows-(?:7-|2008ServerR2)
...
lockV2 yt-dlp/yt-dlp-nightly-builds 2024.10.22.051025 win(?:_x86)?_exe Python 3\.[78]\D.+.+ Windows-(?:7-|2008ServerR2)
...
lockV2 yt-dlp/yt-dlp-master-builds 2024.10.22.060347 win(?:_x86)?_exe Python 3\.[78]\D.+.+ Windows-(?:7-|2008ServerR2)
'''
