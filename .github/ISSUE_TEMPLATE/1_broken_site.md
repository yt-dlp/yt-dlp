...
Add the `-v` flag to your command line you run youtube-dlp with (`youtube-dlp -v <your command line>`), copy the WHOLE output and insert it below. It should look similar to this:
 [debug] System config: []
 [debug] User config: []
