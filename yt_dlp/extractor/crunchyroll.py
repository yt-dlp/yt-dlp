...
class CrunchyrollIE(CrunchyrollBaseIE):
    ...
    _TESTS = [{
        ...
        'url': 'https://www.crunchyroll.com/pt-br/watch/G8WUN8VKP/the-ruler-of-conspiracy',
        'only_matching': True,
    }]
    ...
    def _real_extract(self, url):
        ...
        if '' in available_formats and 'all' not in requested_hardsubs:
            ...
            self.to_screen(
                ...
                '"--extractor-args crunchyroll:hardsub=<language_code or all>". '
                'See https://github.com/yt-dlp/yt-dlp#crunchyroll for more info',
                only_once=True)
        else:
...
class CrunchyrollPlaylistIE(CrunchyrollBaseIE):
    ...
    _TESTS = [{
        ...
        'url': 'https://www.crunchyroll.com/it/series/GY19NQ2QR',
        'only_matching': True,
    }]
