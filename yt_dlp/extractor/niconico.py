...
class NiconicoIE(NiconicoBaseIE):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            'id': 'nm3601701',
            'ext': 'mp4',
            'title': '【ＵＰ主が見たい】Bad Apple!!\u3000ＰＶ【誰か描いてくれ】',
            'availability': 'public',
            'channel': 'Μμ',
            'channel_id': '2883832',
            'comment_count': int,
        ...
        'url': 'https://www.nicovideo.jp/watch/so23335421',
        'info_dict': {
            'id': 'so23335421',
            'ext': 'mp4',
            ...
            'availability': 'public',
            'channel': 'ご注文はうさぎですか？',
            'channel_id': 'ch2591203',
            'comment_count': int,
            'description': 'md5:912c895c114fa377283d3677b2bf0583',
            'display_id': 'so23335421',
            'duration': 1417,
            'genres': ['アニメ'],
            'like_count': int,
            'tags': 'count:5',
            'thumbnail': r're:https?://.+',
            'timestamp': 1397617200,
            'upload_date': '20140416',
            'uploader': 'ご注文はうさぎですか？',
            'uploader_id': 'ch2591203',
            'view_count': int,
        },
        'params': {'skip_download': 'm3u8'},
    }, {
        ...
        'url': 'https://www.nicovideo.jp/watch/so44807263',
        'info_dict': {
            'id': 'so44807263',
            'ext': 'mp4',
            'title': '【ゲスト：南早紀】峯田茉優は香里有佐と仲良くなりたい！ #44（後半放送）',
            'availability': 'subscriber_only',
            'channel': '峯田茉優は香里有佐と仲良くなりたい',
            'channel_id': 'ch2648022',
            'comment_count': int,
            'description': 'md5:35a19c1f5f2631b8a5da66ce8958b812',
            'display_id': 'so44807263',
            'duration': 2199,
            'genres': ['エンターテイメント'],
            'like_count': int,
            'tags': 'count:6',
            'thumbnail': r're:https?://.+',
            'timestamp': 1743325200,
            'upload_date': '20250330',
            'uploader': '峯田茉優は香里有佐と仲良くなりたい',
            'uploader_id': 'ch2648022',
            'view_count': int,
        },
        'params': {'skip_download': 'm3u8'},
        'skip': 'Channel members only',
