...
class N1InfoIIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            ...
            'chapters': [{'start_time': 0.0, 'title': 'Uvod i pitanje za gledaoce', 'end_time': 57.0},
                         {'start_time': 57.0, 'title': 'Za čime će Đoković najviše žaliti?', 'end_time': 162.0},
                         {'start_time': 162.0, 'title': 'Pritisak', 'end_time': 366.0},
                         {'start_time': 366.0, 'title': 'Tajming na udarcima, servis, više sati na terenu',
                          'end_time': 510.0},
                         {'start_time': 510.0, 'title': 'Propuštene brejk lopte, kako?', 'end_time': 670.0},
                         {'start_time': 670.0, 'title': 'Publika nije bitna za ishod', 'end_time': 733.0},
                         {'start_time': 733.0, 'title': 'Novakove suze na konferenciji i plan za budućnost',
                          'end_time': 796.0},
                         {'start_time': 796.0, 'title': 'Grend slem bitke u budućnosti – može li Novak?',
                          'end_time': 972.0}, {'start_time': 972.0, 'title': 'Odgovor na pitanje', 'end_time': 1049}],
            'categories': ['Sports'],
            'tags': ['Novak Djokovic', 'Novak Đoković', 'US Open', 'US Open 2021', 'Daniil Medvedev', 'Danil Medvedev',
                     'Sport Klub Tenis', 'Sport Klub', 'Tennis', 'Tenis'],
