    ...
    _TESTS = [
        {
            ...
            'info_dict': {
                ...
                'ext': 'mp4',
                'thumbnail': 'https://c-fa.cdn.smule.com/smule-gg-uw1-s-8/sing/performance/cover/ca/42/0efb3fc7-6089-4ce2-b493-60b59896c67e.jpg',
        ...
        # Same performer listed multiple times (ensure 'creators' is deduplicated)
        {
            ...
            'info_dict': {
                ...
                'ext': 'mp4',
                'thumbnail': 'https://c-fa.cdn.smule.com/smule-gg-uw1-s-6/sing_google/performance/cover/0c/9e/731aa131-8e07-483b-ac07-08fa3dd4929e.jpg',
        ...
        return {
            ...
            **traverse_obj(
                performance,
                {
                    ...
                    'channel_id': ('owner', 'account_id', {int_or_none}),
