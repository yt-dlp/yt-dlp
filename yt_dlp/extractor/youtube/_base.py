...
INNERTUBE_CLIENTS = {
    ...
    'web_embedded': {
        'INNERTUBE_CONTEXT': {
            'client': {
                ...
                'clientVersion': '2.20260623.00.00',
            },
        },
    ...
    'web_creator': {
        'INNERTUBE_CONTEXT': {
            'client': {
                ...
                'clientVersion': '1.20260622.04.01',
            },
        },
    ...
    'android': {
        'INNERTUBE_CONTEXT': {
            'client': {
                'clientName': 'ANDROID',
                'clientVersion': '21.25.523',
                'androidSdkVersion': 30,
                'userAgent': 'com.google.android.youtube/21.25.523 (Linux; U; Android 11) gzip',
                'osName': 'Android',
                'osVersion': '11',
            },
        },
    ...
    'ios': {
        'INNERTUBE_CONTEXT': {
            'client': {
                ...
                'userAgent': 'com.google.ios.youtube/21.25.523 (iPhone16,2; U; CPU iOS 18_7_2 like Mac OS X;)',
                'osName': 'iPhone',
    ...
    'tv': {
        'INNERTUBE_CONTEXT': {
            'client': {
                'clientName': 'TVHTML5',
                'clientVersion': '7.20260622.15.00',
