...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _TESTS = [{
        ...
        'note': 'Video with "Altered or synthetic content" label',
        'url': 'https://www.youtube.com/watch?v=IhC7N6T_gTg',
        'info_dict': {
            'id': 'IhC7N6T_gTg',
            'ext': 'webm',
            'title': str,
            ...
            'availability': 'public',
            'categories': ['Entertainment'],
            'channel': 'Artificial intelligence (ai)',
            'channel_follower_count': int,
            'channel_id': 'UCC3k651G4Zn-adDJJilYzAA',
            'channel_url': 'https://www.youtube.com/channel/UCC3k651G4Zn-adDJJilYzAA',
            'comment_count': int,
            'description': str,
            'duration': 6,
            'like_count': int,
            'live_status': 'not_live',
            'media_type': 'short',
            'modified_content_notice': 'Altered or synthetic content',
            'playable_in_embed': True,
            'tags': ['ai', 'artificial intelligence', 'ai world leaders', 'world learder satire'],
            'thumbnail': r're:https?://i\.ytimg\.com/.+',
            'timestamp': 1739336817,
            'upload_date': '20250212',
            'uploader': 'Artificial intelligence (ai)',
            'uploader_id': '@oneMileExtra',
            'uploader_url': 'https://www.youtube.com/@oneMileExtra',
            'view_count': int,
        },
        'params': {
            'skip_download': True,
