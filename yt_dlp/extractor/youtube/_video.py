...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    def _live_dash_fragments(self, video_id, itag, client_name, live_start_time, mpd_feed, manifestless_orig_fmt, ctx):
        ...
        CATCHUP_FRAGS = 150
        #CATCHUP_FRAGS = None
        MAX_FRAGMENTS_LIMIT = None  # download max 100 frags

        lack_early_segments = (download_start_time - live_start_time) > MAX_DURATION
        ...
        def _extract_sequence_from_mpd(refresh_sequence, immediate):
            ...
            mpd = mpd_feed(itag, client_name, 5 if expire_fast else 18000)
            if mpd:
