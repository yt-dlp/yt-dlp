...
class InstagramIE(InstagramBaseIE):
    ...
    def _real_extract(self, url):
        ...
        if media:
            ...
            height = int_or_none(self._html_search_meta(('og:video:height', 'video:height'), webpage))
            width = int_or_none(self._html_search_meta(('og:video:width', 'video:width'), webpage))
            description = try_get(
