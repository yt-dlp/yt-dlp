...
class RoosterTeethIE(RoosterTeethBaseIE):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            ...
            'thumbnail': 'https://cdn.roosterteeth.com/image/upload/t_t/f_auto/2/uploads/images/628048ce-850f-41bd-84ad-93d173baf796/original/ep6812.jpg',
        ...
        'expected_warnings': ['Direct m3u8 URL returned HTTP Error 403; retrying with Brightcove extraction'],
        'params': {'skip_download': True},
    }, {
