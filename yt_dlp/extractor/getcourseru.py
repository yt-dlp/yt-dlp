...
class GetCourseRuPlayerIE(InfoExtractor):
    _VALID_URL = r'https?://(?:player02\.getcourse\.ru|cf-api-2\.vhcdn\.com|vhapi02\.gcfiles\.net)/sign-player/?\?(?:[^#]+&)?json=[^#&]+'
    ...
    _TESTS = [{
        ...
        'url': 'https://vhapi02.gcfiles.net/sign-player/?json=example=&s=anyhash',
        'info_dict': {
            'id': '513573381',
            'title': '190bdf93f1b29735309853a7a19e24b3',
            'ext': 'mp4',
            'thumbnail': 'https://vh-123-integros.kinescopecdn.net/preview/190bdf93f1b29735309853a7a19e24b3/preview.jpg?version=1702370546&host=vh-123',
            'duration': 123,
        },
        'skip': 'JWT expired',
    }]
