...
class BiliBiliIE(BilibiliBaseIE):
    ...
    _TESTS = [{
        ...
        'note': 'old video redirects to festival page',
        'url': 'https://www.bilibili.com/video/av706/',
        'info_dict': {
            'id': 'BV1xx411c79H',
            'ext': 'mp4',
            'title': '【東方】Bad Apple!! ＰＶ【影絵】',
            'timestamp': 1256995125,
            'upload_date': '20091031',
            'description': 'md5:d2a9a52deda2e192060fb431c32b47e8',
            'uploader': '折射',
            'duration': 219.195,
            'uploader_id': '37',
            'view_count': int,
