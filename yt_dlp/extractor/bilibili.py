...
class BiliBiliIE(BilibiliBaseIE):
    ...
    _TESTS = [{
        ...
        'note': 'video with collaborators',
        'url': 'https://www.bilibili.com/video/BV1449oBzE4F/',
        'info_dict': {
            'id': 'BV1449oBzE4F',
            'ext': 'mp4',
            'title': '【原创编舞冠军作】【T✰PAZ】野外刷新了异色炫彩mmj！［アンチユー/ANTI YOU］',
            'tags': list,
            'description': 'md5:7e27b748b966de01852f23ffdac182e0',
            'duration': 215.104,
            'upload_date': '20260503',
            'uploader': '兮蔷_',
            'uploader_id': '273745778',
            'timestamp': 1777802400,
            'creators': ['兮蔷_', '是洛凉噢', '南流影', '樱桃烧酒Luo', '亿哩哩'],
            'comment_count': int,
            'view_count': int,
            'like_count': int,
            'thumbnail': r're:^https?://.*\.(jpg|jpeg|png)$',
            '_old_archive_ids': ['bilibili 116509393296679_part1'],
        },
        'params': {'skip_download': True},
    }, {
    ...
    def _real_extract(self, url):
        ...
        metainfo = {
            ...
            **traverse_obj(video_data, {
                ...
                'creators': ('staff', ..., 'name', {str}, all, filter),
            }, get_all=False),
