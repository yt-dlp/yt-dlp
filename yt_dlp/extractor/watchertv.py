...
class WatcherTVIE(InfoExtractor):
    _LOGIN_URL = 'https://www.watchertv.com/login'
    ...
    def _real_extract(self, url):
        ...
        webpage = None
        if self._get_cookies('https://www.watchertv.com').get('_session'):
        ...
        return {
            ...
            'url': VHXEmbedIE._smuggle_referrer(embed_url, 'https://www.watchertv.com'),
...
class WatcherTVSeasonIE(InfoExtractor):
    _PAGE_SIZE = 24
    ...
    def _fetch_page(self, url, season_id, page):
        ...
        yield from [self.url_result(item_url, WatcherTVIE) for item_url in traverse_obj(
