...
class TxxxIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'https://thegay.com/videos/129853/exo-k-practice-dance-history/',
        'md5': '57d7deaa8a000b31af68cf3307c98eb5',
        'info_dict': {
            'id': '129853',
            'display_id': 'exo-k-practice-dance-history',
            'ext': 'mp4',
            'title': 'EXO-K PRACTICE DANCE HISTORY',
            'uploader': 'ncbreedboi',
            'duration': 212,
            'view_count': int,
            'like_count': int,
            'dislike_count': int,
            'age_limit': 18,
            'thumbnail': 'https://tn.thegay.com/contents/videos_screenshots/129000/129853/preview.jpg',
        },
    }, {
