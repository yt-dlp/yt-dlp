...
class MxplayerShowIE(InfoExtractor):
    ...
    _API_SHOW_URL = 'https://api.mxplayer.com/v1/web/detail/tab/tvshowseasons?type=tv_show&id={}&device-density=2&platform=com.mxplay.desktop&content-languages=hi,en'
    _API_EPISODES_URL = 'https://api.mxplayer.com/v1/web/detail/tab/tvshowepisodes?type=season&id={}&device-density=1&platform=com.mxplay.desktop&content-languages=hi,en&{}'
