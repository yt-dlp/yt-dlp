...
class NerdCubedFeedIE(InfoExtractor):
    ...
    def _entries(self, feed):
        for feed_entry in traverse_obj(feed, ('videos', lambda _, v: v['id'])):
    ...
    def _real_extract(self, url):
        ...
        return self.playlist_result(self._entries(feed), video_id, 'nerdcubed.co.uk feed')
