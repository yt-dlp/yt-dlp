...
def getVideoManifest(self, videoID, codecs):
    ...
    headers = {'host':'www.netflix.com',  'content-type':'text/plain',
     ...
     'referer':'https://www.netflix.com/it/title/80117552',
     'accept-language':'it,it-IT;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6,es;q=0.5',
