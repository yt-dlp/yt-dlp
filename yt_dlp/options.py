    ...
    general.add_option(
        ...
        callback_kwargs={
            'allowed_values': {
                ...
                'prefer-legacy-http-handler', 'include-manifest-filesizes'
            }, 'aliases': {
                'youtube-dl': ['all', '-multistreams', '-playlist-match-filter', '-include-manifest-filesizes'],
                'youtube-dlc': ['all', '-no-youtube-channel-redirect', '-no-live-chat', '-playlist-match-filter', '-include-manifest-filesizes'],
                '2021': ['2022', 'no-certifi', 'filename-sanitization', 'no-youtube-prefer-utc-upload-date'],
                '2022': ['no-external-downloader-progress', 'playlist-match-filter', 'prefer-legacy-http-handler', 'include-manifest-filesizes'],
            }
        }, help=(
