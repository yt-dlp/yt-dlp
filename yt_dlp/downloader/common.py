...
class FileDownloader(object):
    ...
    fileopen_retries:   Number of times to retry on file access error
    ...
    def sanitize_open(self, filename, open_mode):
        fileopen_retries = self.params.get('fileopen_retries', 10)
        retry = 0
        while True:
            try:
                ...
                if retry > fileopen_retries:
                    ...
                    self.to_screen(
                        ...
                        % (retry, self.format_retries(fileopen_retries)))
                    time.sleep(0.01)
