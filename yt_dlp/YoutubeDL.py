...
class YoutubeDL:
    ...
    def _write_subtitles(self, info_dict, filename):
        ...
        def add_subtitle_path(sub_info, temp_path, final_path):
            sub_info['filepath'] = temp_path
            if temp_path != '-':
                ret.append((temp_path, final_path))
        ...
        for sub_lang, sub_info in subtitles.items():
            if sub_filename_base == '-':
                sub_filename = sub_filename_final = sub_filename_base
            else:
                ...
                if existing_sub:
                    ...
                    add_subtitle_path(sub_info, existing_sub, sub_filename_final)
                    continue
