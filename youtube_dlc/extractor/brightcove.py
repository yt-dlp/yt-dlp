...
class BrightcoveNewIE(AdobePassIE):
    ...
    def _parse_brightcove_metadata(self, json_data, video_id, headers={}):
        ...
        for source in sources:
            ...
            if not self._downloader.params.get('allow_unplayable_formats', False) and (container == 'WVM' or source.get('key_systems')):
                num_drm_sources += 1
                continue
        ...
        if not formats:
            ...
            if not self._downloader.params.get('allow_unplayable_formats', False) and sources and num_drm_sources == len(sources):
